...
public class AgbFragment extends Fragment {
    ...
    private ImageView agbImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        agbImageView = root.findViewById(R.id.agbImage);
    ...
    private void loadAGB() {
        ...
        String URL = "https://weitblicker.org/rest/info/agb";
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                markwon.setMarkdown(agbTextView,text);
                titleTextView.setText(title);

                Picasso.get().load(urlWeitblick.concat(imageUrl)).
                        placeholder(R.drawable.ic_wbcd_logo_standard_svg2)
                        .error(R.drawable.ic_wbcd_logo_standard_svg2).into(agbImageView);
